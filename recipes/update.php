    ...
    <?php include_once($rootPath.'/header.php'); ?>
        ...
        <form action="<?php echo($rootUrl . 'recipes/post_update.php'); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" placeholder="Seulement du contenu vous appartenant ou libre de droits." id="recipe" name="recipe"><?php echo strip_tags($recipe['recipe']); ?></textarea>
            </div>
